<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"D:\BB\htdocs\fastadmin\public/../application/admin\view\market\good\base\info\edit.html";i:1550242133;s:65:"D:\BB\htdocs\fastadmin\application\admin\view\layout\default.html";i:1550233027;s:62:"D:\BB\htdocs\fastadmin\application\admin\view\common\meta.html";i:1550233027;s:64:"D:\BB\htdocs\fastadmin\application\admin\view\common\script.html";i:1550233027;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-supplier_id" data-field ='company' data-rule="required" data-source="market/supplier/index" class="form-control selectpage" name="row[supplier_id]" type="text" value="<?php echo $row['supplier_id']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-stock" data-rule="required" class="form-control" name="row[stock]" type="number" value="<?php echo $row['stock']; ?>">
        </div>
    </div>
    <div class="form-group">
