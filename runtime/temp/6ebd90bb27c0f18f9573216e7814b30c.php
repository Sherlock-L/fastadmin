<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"D:\BB\htdocs\fastadmin\public/../application/admin\view\market\customer\add.html";i:1550283420;s:65:"D:\BB\htdocs\fastadmin\application\admin\view\layout\default.html";i:1550233027;s:62:"D:\BB\htdocs\fastadmin\application\admin\view\common\meta.html";i:1550233027;s:64:"D:\BB\htdocs\fastadmin\application\admin\view\common\script.html";i:1550233027;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Birthdate'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-birthdate" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[birthdate]" type="text" value="<?php echo date('Y-m-d'); ?>">
        </div>
    </div>
    <div class="form-group">
