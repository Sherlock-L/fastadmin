...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES ('1', 'admin', 'Admin', '49d19ae006e10125b2f08f771d715161', 'e92174', '/assets/img/avatar.png', 'admin@admin.com', '0', '1549866811', '1492186163', '1549866811', '241a64c4-6b69-4db5-8953-35e8108c8548', 'normal');
...
CREATE TABLE `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='管理员日志表';
...
INSERT INTO `fa_auth_group` VALUES ('6', '1', '操作员', '', '1549885577', '1549885577', 'normal');
...
-- ----------------------------
INSERT INTO `fa_market_good_base_info` VALUES ('2', '001', '红萝卜', '14', '/uploads/20190211/418278876312982c51682a7af7ed9768.jpg', '2', '11.00', '122', '11', '1549892584', '1549892584');
INSERT INTO `fa_market_good_base_info` VALUES ('3', '002', '苹果', '15', '/uploads/20190211/f58d13c7984c7ade4da2da15c2aad197.jpg', '2', '132.00', '3334', '22', '1549892634', '1549892634');
INSERT INTO `fa_market_good_base_info` VALUES ('4', '003', '韭菜', '14', '/uploads/20190213/755bb2d85c144c6a0c1d5b19c31e59bb.jpg', '3', '8.00', '1000', '想的一波', '1550056441', '1550056441');
...
CREATE TABLE `fa_market_stock_add` (
  ...
  `createtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='商品入库';
